...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('mvtdocs_core_path', null,
                    $modx->getOption('core_path') . 'components/mvtdocs/') . 'model/';
            $modx->addPackage('mvtdocs', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/mvtdocs/model/schema/mvtdocs.mysql.schema.xml';
